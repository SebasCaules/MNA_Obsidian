...
## [2026-07-02] descarga | finales viejos (Drive 93.54/93.07)
Bajados con Chrome MCP desde el Drive "Grado" -> "93.54 - Metodos Numericos [Avanzados]" -> Examenes (carpeta compartida). Se descargo la carpeta Examenes completa (ZIP 323MB) y se extrajo en raw/Practicas/Examenes_Historicos/ con nombres UTF-8 (via ditto). Contenido: Finales/ (79 archivos, finales reales 2009-2022, codigos 93.07 hasta 2017 y 93.54 desde 2018 = misma materia renumerada; incluye scans JPG/HEIC, .docx y subcarpetas "Final resuelto 2014", "Final 20-02-2018", "Finales virtuales"), Finales Resueltos/ (11 PDFs resueltos 2014-2022), Parciales/ (28) y Parciales Resueltos/ (9), + "Compilado finales_211209_155705.pdf" (89MB, recopilatorio). Total 128 archivos / 317MB. NO ingerido a wiki todavia (solo material fuente en raw/). ZIP original queda en ~/Downloads/drive-download-20260703T004415Z-3-001.zip.

## [2026-07-02] ingest | finales históricos (banco curado)
Ingeridos los finales viejos bajados del Drive (raw/Practicas/Examenes_Historicos/). Hallazgo clave: los 40 finales únicos (2009-2022, códigos 93.07 y 93.54, título "Métodos Numéricos (K)") son de un PROGRAMA VIEJO de métodos numéricos clásicos (interpolación/Chebyshev, Newton-Raphson/Bolzano, optimización por máximo descenso, EDOs por Taylor/Euler, cuadratura) — distinto del MNA-Avanzados 2026 del usuario (álgebra lineal + Fourier, confirmado por el usuario y por el material 2026 que tiene CERO métodos numéricos clásicos). Frecuencias: interpolación 27, Newton-Raphson 23, Taylor 21, EDO 22, Chebyshev 13; vs Fourier 2, TL 0, complejos 0. Creadas 2 páginas: wiki/finales-historicos/index.md (catálogo completo con tabla año/código/¿en-programa?/temas/link-crudo + escaneos e imágenes) y wiki/finales-historicos/banco-en-programa.md (los ÚNICOS ejercicios en scope 2026, curados y verificados: MMCC ajuste temperatura 2009 y ajuste polinómico y=x^3+2x+3 por Cholesky 2019 [residuo 0]; número de condición k2=1.2832 de [[-3,2],[2,4]] 2010; SVD/valores singulares nulos por rango 2021; definida positiva por autovalores 2022; diferencias finitas 2016/2017/2022). Enlazado desde index.md. Banco curado: NO se transcribió cada final (mayoría fuera de programa), se cataloga todo + se extrae el solapamiento.

## [2026-07-02] build | megadoc PDF de estudio
Generado study/MNA_Megadoc.pdf (44 pág) — documento único de estudio para el final 2026 (álgebra lineal + Fourier). Estructura: portada + índice + "cómo usar" + mapa de temas con frecuencias + 15 temas (complejos, vectores/PI, matrices/det, espacios vectoriales, TL, cambio de base, diagonalización, LU/PLU, QR/Cholesky, SVD, pseudoinversa, cuadrados mínimos, series de Fourier, TF, diferencias finitas) cada uno con cajas Teoría esencial / Receta de examen / Ejemplo(s) resuelto(s) tomados de los 30 modelos oficiales y verificados, + trampas frecuentes; apéndices: formulario relámpago, banco de práctica (30 modelos) y checklist del examen. Fuente LaTeX en study/megadoc/ (main.tex + preamble.tex + 00-intro + sec1..sec5 + 99-apendice), compilable con xelatex (usa fontspec + babel-es + tcolorbox). Los 5 cuerpos temáticos se redactaron con agentes en paralelo desde las páginas de wiki verificadas; los agentes reportaron y se corrigieron erratas de fuentes (Cauchy-Schwarz mal escrita en un slide, PI hermítico sin conjugar, notación adjunta/conjugada transpuesta). Enlazado desde wiki/index.md.
